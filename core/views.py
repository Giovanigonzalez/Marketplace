...
class homeview(View):
    def get(self,request,*args,**kwargs):
        ...
        if products:
            if products:
                #PAGINAR EL OBJETO PRODUCTO
                # 9 EL LA CANTIDAD DE PRODUCTOS QUE QUEREMOS MOSTRAR ANTES DE PAGINAR
...
class ProductDetailView(View):
    def get(self,request,slug,*args,**kwargs):
        ...
        if self.request.user.is_authenticated:
            if product in self.request.user.library.product.all():
                has_access = True
...
def stripe_webhook(request, *args, **kwargs):
    ...
    if event["type"] == CHECKOUT_SESSION_COMPLETED:
        ...
        try:
            ...
            try:
            ...
            except User.DoesNotExist: # si no lee solo poner except
                ...
                send_mail(
                    ...
                    from_email="market <giovanigonzavillalba@gmail.com>"
                )
